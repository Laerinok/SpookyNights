...
*   **The Resistance:** Ordinary weapons (Copper, Iron, Steel) deal **-50% Damage** to spectral enemies.
*   **The Solution:** You must craft weapons using **Spectrium** and its alloys to bypass this resistance.
    *   **Spectrium:** Deals normal damage (100%).
    *   **Etherium:** Deals **+20%** Bonus Damage.
    *   **Aetherium:** Deals **+40%** Bonus Damage.

### 2. New Metallurgy & Weapons
Harvest **Spectral Hearts** from fallen spirits to forge new gear.
*   **The War Scythe:** A new polearm with a massive **3.2m range**, allowing you to strike dangerous entities from a safe distance. Heavy to hold, but deadly.
*   **Spectral Arsenal:** Craft Falx blades, Spears, and Arrows using the new alloys.
*   **Alloys:**
    *   *Etherium:* A durable blend of Copper and Spectrium.
    *   *Aetherium:* The ultimate ghost-hunting metal, fused with Bismuth and Silver.
...
Face new variants of Drifters, Wolves, Bears, and Archers that glow in the dark and require specific strategies to defeat.
